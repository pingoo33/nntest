...
python3 main.py --model kfold_mnist --seed 2000 --threshold_nc 0 --sec_kmnc 10 --threshold_cc 6 --threshold_gc 0.8 --symbols_sq 2 --seq [1,5] --size_tkc 3 --size_tkpc 3 --mode test
python3 main.py --model mnist --seed 2000 --threshold_nc 0 --sec_kmnc 10 --threshold_cc 6 --threshold_gc 0.8 --symbols_sq 2 --seq [1,5] --size_tkc 3 --size_tkpc 3 --mode test
