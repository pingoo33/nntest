...
class StepWiseCoverage(RLCoverage):
    ...
    def display_graph(self):
        ...
        plt.ylabel('coverage')
        plt.title('Step-Wise Coverage of ' + self.layer.name)
        plt.savefig('output/' + self.model_name + '/' + self.layer.name + '_sc.png')
        plt.clf()
    ...
    def display_frequency_graph(self):
        ...
        title = self.layer.name + ' Frequency of Step-Wise Coverage'
        ...
        plt.savefig('output/' + self.model_name + '/' + self.layer.name + '_sc_Frequency.png')
        plt.clf()
